          ...
          <div className="text-slate-300 text-justify">
            ...
            <p>
              ...
              <div className="mt-12 grid grid-cols-1 2xl:grid-cols-3 lg:grid-cols-2 gap-x-12 gap-y-12 items-start">
                ...
                <AchievementCard title={"Touch 'n Go Innovative Group Challenge"} description={"1-month competition to brainstorm and provide innovative solutions to the given problem statement."} year={"2023"} award={"Runner-up"} />
